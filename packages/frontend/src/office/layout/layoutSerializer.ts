import { TileType, FurnitureType, DEFAULT_COLS, DEFAULT_ROWS, TILE_SIZE, Direction } from '../types.ts'
import type { TileType as TileTypeVal, OfficeLayout, PlacedFurniture, Seat, FurnitureInstance, FloorColor } from '../types.ts'
import { getCatalogEntry } from './furnitureCatalog.ts'
import { getColorizedSprite } from '../colorize.ts'
