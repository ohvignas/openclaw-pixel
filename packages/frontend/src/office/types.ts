...
export const FurnitureType = {
  ...
  PC: 'pc',
  LAMP: 'lamp',
  HOME_RUG_LOUNGE: 'home_rug_lounge',
  HOME_RUG_WORK: 'home_rug_work',
  HOME_SOFA: 'home_sofa',
  HOME_COFFEE_TABLE: 'home_coffee_table',
  HOME_DESK_WHITE: 'home_desk_white',
  HOME_DESK_WHITE_ALT: 'home_desk_white_alt',
  HOME_TABLE_WOOD: 'home_table_wood',
  HOME_CHAIR_OAK: 'home_chair_oak',
  HOME_CHAIR_OAK_ALT: 'home_chair_oak_alt',
  HOME_CHAIR_FRONT: 'home_chair_front',
  HOME_CHAIR_BACK: 'home_chair_back',
  HOME_CHAIR_LEFT: 'home_chair_left',
  HOME_CHAIR_RIGHT: 'home_chair_right',
  HOME_MONITOR: 'home_monitor',
  HOME_COMPUTER_BACK: 'home_computer_back',
  HOME_COMPUTER_FRONT: 'home_computer_front',
  HOME_BOOKSHELF_WIDE: 'home_bookshelf_wide',
  HOME_BOOKSHELF_LOW: 'home_bookshelf_low',
  HOME_PLANT_TALL: 'home_plant_tall',
  HOME_PLANT_SMALL: 'home_plant_small',
  HOME_FLOOR_LAMP: 'home_floor_lamp',
} as const
